...
metaTitle: "Building a Collection-Based Navigation Menu in Vendure"
metaDescription: "Query top-level collections from the Vendure Shop API and transform them into a hierarchical navigation tree for your storefront."
---
